...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('JrowlandsnzTodoApiBundle:Task:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('JrowlandsnzTodoApiBundle:Task:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('JrowlandsnzTodoApiBundle:Task:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('JrowlandsnzTodoApiBundle:Task:edit.html.twig', array(
            'entity'      => $entity,
